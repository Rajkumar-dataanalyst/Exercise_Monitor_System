...
with tab1:
    with st.form("registration form", border = True):
        ...
        f_name = col1.text_input("**First Name**", placeholder="Enter here....")
        l_name = col2.text_input("**Last Name**", placeholder="Enter here....")
        col3, col4 = st.columns([2,1])
        email= col3.text_input("**Email**", placeholder="Enter email here....")
        role = col4.selectbox('**Role**', ("Trainee", "Trainer"), index = None, placeholder="Select your role here....")
        col5, col6 = st.columns(2)
        gender = col5.selectbox("**Gender**", ("MALE", "FEMALE", "OTHERS"), index=None, placeholder="Select your gender")
        dob = col6.date_input("**Select your date of birth**", format="DD/MM/YYYY", value=None, min_value=datetime.date(1950, 1, 1), max_value=datetime.date.today())
        password = col5.text_input("**Password**", type="password", placeholder="Enter password here....")
        password1 = col6.text_input("**Re-Enter Password**", type="password", placeholder="Re-Enter password here....")
            ...
            if verify_email(verification_code, user_verification_code):
                ...
                if role == "Trainer":
                    ...
                    trainer_data = {
                        "_id": email,
                        "groups": {},
                        "exercises": ["Curl", "Push-up", "Squat", "Jumping-jack", "V-up", "High-knees", "Forward-bend", "Forward-extensions"]    
                    }
